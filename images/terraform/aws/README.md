...
terraform, helm, kubectl, git, and aws-iam-authenticator for EKS, using the runner-injected kubeconfig.

| | |
| --- | --- |
| image | `nuonco/terraform-aws` |
...
| dockerfile | [`images/terraform/aws/Dockerfile`](./Dockerfile) |
| status | experimental |
...
[public]
image_url = "nuonco/terraform-aws"
tag       = "1.16.2"
...
name    = "terraform-plan"
timeout = "15m"
image   = "{{.nuon.components.terraform-aws.outputs.image.ref}}"

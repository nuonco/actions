...
terraform, helm, kubectl, git, and gke-gcloud-auth-plugin for GKE, using the runner-injected kubeconfig.

| | |
| --- | --- |
| image | `nuonco/terraform-gcp` |
...
| dockerfile | [`images/terraform/gcp/Dockerfile`](./Dockerfile) |
| status | experimental |
...
[public]
image_url = "nuonco/terraform-gcp"
tag       = "1.16.2"
...
name    = "terraform-plan"
timeout = "15m"
image   = "{{.nuon.components.terraform-gcp.outputs.image.ref}}"
